...
function CreateUpdateUserRoleMasterSave()
{
	...
	if($('#user_role_id').val()==0) { alert('Select User Role'); $('#user_role_id').focus(); return false; }
	...
	*/
	pageParams.push({name:'user_role_id', value:user_role_id});
...
function closeUserRoleMasterDiaglog()
{
