<?php
	...
	class RPDF extends PDF
	{
		function Header()
		{
			...
			/*$this->Cell(40,7,'Employee ID',1,0,'L');
			$this->SetFont('Verdana','',9);
			$this->Cell(55,7,$this->employee_code,1,0,'L');
			$this->SetFont('Verdana-Bold','',9);
			$this->Cell(40,7,'Designation',1,0,'L');
			$this->SetFont('Verdana','',9);
			$this->Cell(55,7,$this->designation_name,1,0,'L');
			
			$this->ln(7);
			//$this->SetFont('Verdana-Bold','',9);
			//$this->Cell(40,7,'ESI # / Mediclaim #',1,0,'L');
			//$this->SetFont('Verdana','',9);
			//$this->Cell(55,7,$this->esi_number,1,0,'L');
			$this->SetFont('Verdana-Bold','',9);
			$this->Cell(40,7,'PF Number',1,0,'L');
			$this->SetFont('Verdana','',9);
			$this->Cell(150,7,$this->pf_number,1,0,'L');
			
			$this->ln(15);
			$this->SetFillColor(230, 230, 230);
			$this->SetTextColor(100, 100, 100);
			$this->SetFont('Verdana-Bold','',9);
			$this->Cell(55,7,'Earnings',1,0,'L',1);
			$this->Cell(40,7,'Amount',1,0,'R',1);
			$this->Cell(55,7,'Deductions',1,0,'L',1);
			$this->Cell(40,7,'Amount',1,0,'R',1);
			$this->ln(7);
			$this->SetFont('Verdana','',9);
*/
