          ...
          <div class="card">
            <div class="header">
              ...
              <div class="actionsBar">
				...
				<button type="button" class="btn btn-warning m-t-15 waves-effect closeDialog" onclick="loadPOEntryMaster();">Back</button>-->
              </div>
            </div>
            <div class="body">
              <div class="tab ">
              ...
              <div id="divTabPoEntry" class="tabcontent">
                <div id="showPoEntry">
              ...
              <div id="divTabSuppAssig" class="tabcontent">
