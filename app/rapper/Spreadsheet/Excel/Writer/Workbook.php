...
$ROOT_DIR = $maindir.'/rapper/';
require_once $ROOT_DIR.'Spreadsheet/Excel/Writer/Format.php';
require_once $ROOT_DIR.'Spreadsheet/Excel/Writer/BIFFwriter.php';
require_once $ROOT_DIR.'Spreadsheet/Excel/Writer/Worksheet.php';
require_once $ROOT_DIR.'Spreadsheet/Excel/Writer/Parser.php';
require_once $ROOT_DIR.'OLE/PPS/Root.php';
require_once $ROOT_DIR.'OLE/PPS/File.php';
